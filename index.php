  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <h1 class="text-white">PROVINSI BALI</h1>
        <p class="text-white">
          Sistem informasi ini merupakan aplikasi pemetaan geografis tempat wisata di wilayah Bali. Aplikasi ini memuat informasi dan lokasi dari tempat wisata di Bali.
        </p>
...
<section id="peta_wisata" class="about-info-area section-gap">
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyByE3g3saT23dZJvuuzL1_813TbgtfGFR4 "></script>
      ...
      <script type="text/javascript">
        function initialize() {
          ...
          var mapOptions = {
            zoom: 10.2,
            center: new google.maps.LatLng(-8.819863, 115.1518136),
